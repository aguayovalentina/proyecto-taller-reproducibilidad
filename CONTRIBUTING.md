# Contributing to proyecto taller reproducibilidad

First off, thanks for taking the time to contribute to `proyecto taller reproducibilidad`!
...
[Contributor Code of Conduct](https://github.com/aguayovalentina/proyecto taller reproducibilidad/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report 
unacceptable behavior to <va.aguayo@uc.cl>.
...
`proyecto taller reproducibilidad` uses the `lower_snake_case`.
...
[Issues](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues) that might help 
...
- Open a new [Issue](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues/new).
- Use the template [other_issue.md](https://github.com/aguayovalentina/proyecto taller reproducibilidad/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
- Make sure that you are using the latest version of `proyecto taller reproducibilidad`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues) to 
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues/new).
- Use the template [bug_report.md](https://github.com/aguayovalentina/proyecto taller reproducibilidad/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `proyecto taller reproducibilidad`.
- Read the [documentation](https://github.com/aguayovalentina/proyecto taller reproducibilidad/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues) to 
...
[GitHub Issues](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues).

- Open a new [Issue](https://github.com/aguayovalentina/proyecto taller reproducibilidad/issues/new).
- Use the template [feature_request.md](https://github.com/aguayovalentina/proyecto taller reproducibilidad/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the suggestion.
- Provide a step-by-step description of the suggested enhancement in as 
many details as possible.
- Explain why this enhancement would be useful to most `proyecto taller reproducibilidad` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/aguayovalentina/proyecto taller reproducibilidad/compare).
